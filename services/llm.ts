...
4.  **神职冲突与逻辑准则 (GOD ROLE LOGIC)：**
    * **唯一性原则：** 预言家、女巫、猎人、守卫等神职在全场【均只有一位】。
    * **非对跳不攻击：** 当场上只有一人申明某个神职身份（例如“单边预”或“单边女巫”）时，如果你手中并没有该神职牌，通常应默认其身份的可能性为高。
    * **禁止无端攻击：** 尤其是作为平民，在没有人与之“对跳”（竞争同一身份）的情况下，严禁仅凭直觉就去猛烈攻击或怀疑唯一的申明者。这不符合好人逻辑。
    * **战略观察：** 你可以保持中立观察，或等待发言轮次中是否有竞争者出现。但在无竞争者时，你的发言和投票应优先倾向于保护或信任该申明者。
