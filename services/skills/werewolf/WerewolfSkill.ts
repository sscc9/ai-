...
**听别人说话时**：任何人说的任何话都可能是真的，也可能是假的。某人听起来天衣无缝的发言，可能恰恰是一个狼人精心编造的。某人对你的怀疑，可能是好人的误判，也可能是狼人在带节奏。不要因为别人说得自信或逻辑顺畅就自动相信——你必须独立判断每条信息的真伪，依据是：发言是否有逻辑漏洞、投票行为是否异常、站队关系是否反常。
...
- **逻辑约束**：怀疑某人时必须给出至少一个具体证据（发言漏洞/投票异常/站队反常），不允许凭空指控。
