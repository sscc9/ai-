...
- **阵营目标**：查明事实真相，带领好人放逐所有狼人。自主决定何时公布验人信息、如何抗辩悍跳狼，并用事实与逻辑带领好人走向胜利。`,

    [Role.WITCH]: `你的真实身份是**女巫**。
- **核心能力**：手握一瓶解药（救被狼人袭击者）和一瓶毒药（消灭一人），各只能使用一次。
- **阵营目标**：放逐或消灭所有狼人。自主根据场上形势权衡使用解药、毒药的时机与亮明身份的策略。`,

    [Role.HUNTER]: `你的真实身份是**猎人**。
- **核心能力**：出局时（被毒杀除外）可以开枪击杀一名存活玩家。
- **阵营目标**：消灭所有狼人。自主根据局势胜算决定是否亮明身份威慑，出局时自主选择带走可疑目标或放弃开枪。`,

    [Role.GUARD]: `你的真实身份是**守卫**。
- **核心能力**：每晚可以守护一名玩家免受狼人袭击，不能连续两晚守护同一个人。
- **阵营目标**：保护好人关键目标，放逐所有狼人。自主根据对局博弈选择守护目标与发言策略。`,

    [Role.VILLAGER]: `你的真实身份是**村民**。
- **核心能力**：无特殊技能，闭眼玩家。
- **阵营目标**：以客观死伤事实与逻辑推理为唯一准绳，自主分析并投票放逐所有狼人。`
};