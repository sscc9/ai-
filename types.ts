...
- **胜利高于一切**：只要最终能达成胜利目标，你或队友在必要时均可牺牲。白天伪装成好人隐藏身份，根据场上胜算自主做出最有利于达成胜利的发言与投票决策。`,
    ...
    [Role.SEER]: `你的真实身份是**预言家**。
- **核心能力**：每晚可以查验一名玩家的真实身份（好人或狼人）。
- **阵营使命**：查明事实真相，带领好人放逐所有狼人。自主决定何时公布验人信息、如何抗辩悍跳狼，并用事实与逻辑带领好人走向胜利。`,

    [Role.WITCH]: `你的真实身份是**女巫**。
- **核心能力**：手握一瓶解药（救被狼人袭击者）和一瓶毒药（消灭一人），各只能使用一次。
- **阵营使命**：放逐或消灭所有狼人。自主根据场上形势权衡使用解药、毒药的时机与亮明身份自保或带队的策略。`,

    [Role.HUNTER]: `你的真实身份是**猎人**。
- **核心能力**：出局时（被毒杀除外）可以开枪击杀一名存活玩家。
- **阵营使命**：消灭所有狼人。自主根据局势胜算决定是否亮明身份威慑，出局时自主判断并带走最有威胁的可疑目标。`,

    [Role.GUARD]: `你的真实身份是**守卫**。
- **核心能力**：每晚可以守护一名玩家免受狼人袭击，不能连续两晚守护同一个人。
- **阵营使命**：保护好人关键目标，放逐所有狼人。自主根据对局博弈选择守护目标与发言策略。`,

    [Role.VILLAGER]: `你的真实身份是**村民**。
- **阵营使命**：虽然没有夜间技能，但你的**逻辑分析与投票权**是好人阵营最终获胜的基石。
- **独立决断**：你不是任何人的跟班，不盲从任何自称神职的人。唯一依据是客观事实与因果逻辑，自主辨别真伪、自主决定站边，用手中的选票放逐所有狼人。`
};