...
const HumanInputPanel = () => {
    ...
    return (
        <>
            {/* Collapsed Pill */}
            <div className={clsx(
                "fixed z-[100] transition-all duration-300 transform origin-bottom backdrop-blur-2xl border",
                isCollapsed
                ...
                <div className="w-full flex items-center justify-between py-1 px-3">
                    <div className="flex items-center gap-2 min-w-0">
                        <span className="relative flex h-2 w-2 shrink-0">
                            <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-indigo-400 opacity-75"></span>
                            <span className="relative inline-flex rounded-full h-2 w-2 bg-indigo-500"></span>
                        </span>
                        <span className={clsx("font-bold text-sm shrink-0", isDay ? "text-indigo-600" : "text-indigo-400")}>
                            你的回合 ({humanPlayer.role})
                        </span>
                        {instruction && (
                            <span className={clsx(
                                "text-xs font-medium border-l pl-2 ml-1 hidden sm:inline max-w-[200px] truncate",
                    ...
                    <button
                        ...
                        className="flex items-center gap-1.5 px-4 py-1.5 bg-indigo-600 hover:bg-indigo-700 text-white rounded-full text-xs font-bold transition-all shadow-md active:scale-95 shrink-0"
                    >
                        <span>展开面板行动</span>
            ...
            <div className={clsx(
                ...
                isDay
                    ? "bg-white/95 border-slate-200/80 shadow-[0_20px_50px_rgba(0,0,0,0.15)] text-slate-800"
                    : "bg-[#0b0f19]/95 border-slate-800/80 shadow-[0_30px_60px_rgba(0,0,0,0.5)] text-slate-100"
            )}>
